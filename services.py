...
def administrar_chatbot(text,number, messageId, name):
    ...
    if "hola" in text:
        body = "¡Hola! 👋 Bienvenido a AbotI. ¿Cómo podemos ayudarte hoy?"
        footer = "Equipo AbotI"
        ...
        footer = "Equipo AbotI"
        options = ["Creacion de Webs", "Creacion de Chat Telegram", "Creacion de Chat Whastapp"]
        ...
        footer = "Equipo ABotI"
        options = ["📅 10: mañana 10:00 AM", "📅 7 de Julio, 2:00 PM", "📅 8 de Julio, 4:00 PM"]

        listReply = listReply_Message(number, options, body, footer, "sed5",messageId)
        list.append(listReply)
    elif "7 de julio, 2:00 pm" in text:
        body = "Excelente, has seleccionado la reunión para el 7 de julio a las 2:00 PM. Te enviaré un recordatorio un día antes. ¿Necesitas ayuda con algo más hoy?"
        footer = "Equipo AbotI"
